...
<body>
	...
	<div class="breadcrumbs">
		<div class="container"><a href="/">Home</a>&nbsp;/&nbsp;<a href="about.php">About OBG</a>&nbsp;/&nbsp;Board of Directors
	</div>
	...
	<div class="page_wrapper">
		<section class="container">
			...
			<div id="whyadopt" class="page with_sidebar">
				...
				<!-- Gallery Boards HERE - Pic left and text right aligned-->
				...
				<!-- Gallery Officers HERE  - Pic left and text right aligned -->
