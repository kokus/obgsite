			...
			<div id="about" class="page with_sidebar">
				...
				<div class="breadcrumb_navigation">
						<ol class="breadcrumb_list">
							...
							<li>
								<span class="nav_sep">&raquo;</span>
								<span><a href="adopt_dogs.php">Our Dogs</a></span>
							</li>
							<li>
								<span class="nav_sep">&raquo;</span>
								<span>Dog Name Here</span>
							</li>
						</ol>
				</div>
				<!-- End Breadcrumb -->
				...
				<h2> Adult | Male </h2>
					<div class="two_thirds">
						...
						<p>Adams is respectful to and gets along with cats.  If you are looking for a lover boy, then Adams is your man...dog. Adams is a big time kisser and will sit in your lap once he knows and trusts you! He does have trouble getting up on the couch but he does not like to receive help. Adams is a determined little guy and finds his own ways to get up on the couch and snuggle with his favorite human.</p>
